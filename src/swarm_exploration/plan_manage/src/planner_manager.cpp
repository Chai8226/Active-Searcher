...
void FastPlannerManager::planInspectTraj(const vector<Eigen::Vector3d>& tour,
...
void FastPlannerManager::planTrajWithTarget(const vector<Eigen::Vector3d>& tour,
  ...
  PolynomialTraj init_traj;
  PolynomialTraj::waypointsTraj(pos, cur_vel, target_vel, cur_acc, zero, times, init_traj);
