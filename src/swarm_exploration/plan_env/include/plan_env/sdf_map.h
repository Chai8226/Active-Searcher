...
public:
  ...
  void getMapBoundary(Eigen::Vector3d& min_boundary_, Eigen::Vector3d& max_boundary_); 
...
inline void SDFMap::getMapBoundary(Eigen::Vector3d& min_boundary_, Eigen::Vector3d& max_boundary_){
  min_boundary_ = mp_->map_min_boundary_; 
  max_boundary_ = mp_->map_max_boundary_; 
}
